...
export default function Home() {
  return (
    <div>
      {/* To put "SharkPark" on the tab in the browser */}
      <Head>
      ...
      <main>
        ...
        <Image src={IMG_0885} height = {240} width= {290}/>
            ...
            <div className="owner"> 
                <a href="http://localhost:3000/posts/owner-listing">
                  <h3>List Your Parking Spot</h3>
                </a>
           </div>
          
          
                <a href="http://localhost:3000/posts/enter-location" className="card">
