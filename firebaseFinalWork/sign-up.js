...
function redirectingNext() {
  window.location.href="http://localhost:3000/posts/account-created";
}

const databaseAddParker = async () => {
  signingUp();
  await db.collection('parkers').add({
    firstLast: firstLast.value,
    username: username.value,
    vehicleDesc: vehicleDesc.value,
...
/*
<a href="http://localhost:3000/posts/account-created">
...
export default function signUp() {
    ...
    <><main>
        ...
        <p>
            ...
            <input className = "card" type="email" id="email" placeholder="Email"></input>
            ...
            <input className = "card" type="text" id="vehicleDesc" placeholder="Vehicle Make/Model"></input>
            <input className = "card" type="text" id="plateNumber" placeholder="License Plate Number"></input>
            <input className = "card" type="text" id="license" placeholder="License Plate Number"></input>

            <button onClick={() => {databaseAddParker();}}>{" "} SignUp </button>
